...
namespace ybinterface_lib.SY.UI
{
    public partial class FrmmxbbNK : InfoForm
    {
        ...
        {
             yb_interface_sy_zrNew.frmbzbm = DataGridView.CurrentRow.Cells["bzbm"].Value.ToString();
            yb_interface_sy_zrNew.frmbzmc = DataGridView.CurrentRow.Cells["bzmc"].Value.ToString();
             this.Close();
        }
