...
namespace yb_interfaces
{
    public partial class FrmYBRegister : InfoForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            object[] res = yb_interface_jx.YBMZDK(null);
            ...
            res = yb_interface_jx.YBMZDJ(req);
            if (res[1].ToString() == "1")
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            object[] ii = yb_interface_jx.YBMZSFYJS(objres);
            if (ii[1].ToString() == "1")
            {
                ...
                object[] i1 = yb_interface_jx.YBMZSFJS(objresjs);
                if (i1[1].ToString() == "1")
                {
