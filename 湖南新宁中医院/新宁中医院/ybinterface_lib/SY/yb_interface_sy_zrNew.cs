...
select
        ...
        private static object[] UpLoadByGroup(int start, int end, DataSet ds, string jzlsh, string yllb)
        {
            ...
            for (int f = start; f < end; f++)
            {
                ...
                else
                {
                    ...
                    feeinfo.feedetl_sn = dr["cflsh"].ToString();
                    ...
                    feeinfo.umamt = Math.Round(Convert.ToDecimal(dr["je"].ToString()), 2, MidpointRounding.AwayFromZero);//Math.Round 方法是老外理解四舍五入是  四舍六入   中国人的四舍五入取上面的方法
        ...
        private static object[] YBZYFYMXSC(object[] inParams)
        {
            ...
            string Sql = string.Format(@"select b.ybxmbh,b.ybxmmc,a.z3djxx as dj,
                                        ...
                                        group by b.ybxmbh,b.ybxmmc,a.z3djxx,a.z3item,a.z3name,a.z3sfno,b.sfxmzldm,b.sflbdm,b.sfxmdjdm,z3yzxh+CONVERT(varchar(20),z3idxx),z3ghno+CONVERT(varchar(20),z3idxx),z3empn,z3ksno
            ...
            if (status == 1)
            {
                strSql = string.Format(@"update zy03d set z3ybup = '{0}' where z3ybup is null and LEFT(z3kind,1)=2 and z3zyno = '{1}' and z3item in (select  r.hisxmbh from ybhisdzdr r)", ybjzlsh, jzlsh);
                liSql.Add(strSql);
        ...
        public static object[] YBZYSFYJS(object[] objParam)
        {
            ...
            try
            {
                ...
                string outdatestr = outdate.ToString("yyyyMMddHHmmss");
                string data = "{\"ipt_otp_no\":\"" + ybjzlsh + "\",\"mdtrt_id\":\"" + djh + "\",\"med_type\":\"" + yllb + "\",\"setl_time\":\"" + jsdate + "\",\"dscg_time\":\"" + jsdate + "\",\"dscg_trt_rslt\":\"" + cyyy + "\",\"diag_code\":\"" + bzbh + "\",\"psn_no\":\"" + bxh + "\",\"adm_dept_codg\":\"" + deptCode + "\",\"atddr_no\":\"" + ysbh + "\",\"diag_dscr\":\"" + cyzd + "\",\"occupationalType\":\"" + occupationalType + "\"}";
        ...
        public static (int code, string result) TotalDZ(string start, string end, ref object[] resarr, string opercode = "")
        {
            ...
            if (i > 0)
            {
                ...
                decimal total = Convert.ToDecimal(j["medfee_sumamt"].ToString());
                decimal pubcost = Convert.ToDecimal(j["hifp_pay"].ToString());
                decimal ownCost = Convert.ToDecimal(j["psn_cash_pay"].ToString());
