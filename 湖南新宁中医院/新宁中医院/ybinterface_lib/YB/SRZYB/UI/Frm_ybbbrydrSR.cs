...
{
    public partial class Frm_ybbbrydrSR : InfoForm
    {
        public Frm_ybbbrydrSR()
        {
            InitializeComponent();
        }
        ...
        private bool GetYBInfo(ref string backmsg)
        {
            ...
            if(checkBox1.Checked)
                isYD = "1";
            object[] obj = { isYD };
            object[] back_mess = yb_interface.ybs_interface("2201", obj);
        ...
        private void btn_RegisterYB_Click(object sender, EventArgs e)
        {
            ...
            string isYD = checkBox1.Checked ? "1" : "0";
            object[] back_mess, param = new object[] { txt_zyno.Text, txt_yllb.Tag, txt_bz.Tag, txt_bz.Text, txt_grbh.Tag, txt_lyjg.Tag, txt_lyjg.Text, txt_yllb.Text, txt_dgys.Tag, txt_dgys.Text, txtZSZH.Text.Trim(), txtSYLB.Tag, txtJHSYLB.Tag, isYD };
