...
namespace yb_interfaces.YB.湖南.UI
{
    public partial class FrmmxbbNK : InfoForm
    {
        ...
        {
             yb_interface_hn_nkNew.frmbzbm = DataGridView.CurrentRow.Cells["bzbm"].Value.ToString();
            yb_interface_hn_nkNew.frmbzmc = DataGridView.CurrentRow.Cells["bzmc"].Value.ToString();
             this.Close();
        }
