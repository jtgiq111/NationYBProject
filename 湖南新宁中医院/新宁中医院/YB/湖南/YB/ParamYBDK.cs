...
{
	// ybinterface_lib.ParamYBDK
	public class ParamYBDK
	{
		private string grbh;
		...
		public string Bngwybcyljjzflj
		{
			get
			{
				return bngwybcyljjzflj;
			}
			set
			{
				bngwybcyljjzflj = value;
			}
		}
		...
		public string Gwybcylndsykbje
		{
			get
			{
				return gwybcylndsykbje;
			}
			set
			{
				gwybcylndsykbje = value;
			}
		}
