...
{
    public partial class Frm_ybjsfzTS : InfoForm
    {
        ...
        internal void getInfo1()
        {
            ...
            if (MZLB.Equals("1"))
            {
                strSQL = string.Format(@"select c.b1name jbr,a.jbr as jbrbh,a.jzlsh,b.xm,b.grbh as sbh,a.ylfze as fyhj,
                                        a.zbxje as bxje,a.tcjjzf as tczf,a.zhzf as zfhj,a.xjzf,a.sysdate as bxrq,qfbzfy as qfxje,
                                        b.bzbm,b.bzmc,a.dejjzf as dbjjzf,a.mzjzfy as jzje,
                                        ...
                                        where a.cxbz=1 and len(a.jzlsh)=8 and convert(datetime,a.sysdate) between '{0}' and '{1}' and a.xm like '%{2}%' and {3} {4}",
            ...
            {
                strSQL = string.Format(@"select c.b1name as jbr,a.jbr as jbrbh,a.jzlsh,b.xm,b.grbh as sbh,a.ylfze as fyhj,
                                        (ylfze-xjzf) as bxje,a.tcjjzf as tczf,a.zhzf as zfhj,a.xjzf,a.sysdate as bxrq,qfbzfy as qfxje,
                                        b.mmbzbm1 as bzbm,b.mmbzmc1 as bzmc,a.dejjzf as dbjjzf,a.mzjzfy as jzje,
                                        a.dwfdfy as dwfdfy,a.lxgbddtczf as lxgbddtczf,a.zdjbfwnbcje as zdjbfwnbcje,a.zdjbfwybcje as zdjbfwybcje,
                                        a.yyfdfy as yyfdfy,a.ecbcje as ecbcje,a.mzdbjzje as mzdbjzje,a.czzcje as zftdje
                                        from ybfyjsdr a
                                        left join ybmzzydjdr b on a.jzlsh=b.jzlsh and a.cxbz=b.cxbz
                                        left join bz01h  c on c.b1empn=a.jbr
                                        where a.cxbz=1 and len(a.jzlsh)=9 and convert(datetime,a.sysdate) between '{0}' and '{1}' and a.xm like '%{2}%' and {3} {4}",
                                        dtStart, dtEnd, sNAME, sQFXJE, jbr);
        ...
        internal void getInfo()
        {
            ...
            if (MZLB.Equals("1"))
            {
                strSQL1 = string.Format(@"with fyhj
                                            ...
                                            and convert(datetime,a.sysdate) between '{0}' and '{1}' and a.xm like '%{2}%' and {3} {4}
                                            )
