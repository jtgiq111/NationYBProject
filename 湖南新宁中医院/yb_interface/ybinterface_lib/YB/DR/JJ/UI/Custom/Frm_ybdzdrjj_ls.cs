...
{
    public partial class Frm_ybdzdrjj_ls : InfoForm
    {
        int _YBScrollValue = 0;
        int _HisScrollValue = 0;

        public Frm_ybdzdrjj_ls()
        {
            InitializeComponent();
        ...
        void BindGrids()
        {
            ...
            if (rbtnDrug.Checked)
            {
                ...
                where a.y1yplx in ('X', 'Z') 
                and a.y1ypno not in (select Hisxmbh from YBhisDZdr20171231)";
            ...
            else if (rbtnTherapy.Checked)
            {
                ...
                where not exists (select 1 from YBhisDZdr20171231 c where c.hisxmbh = a.b5item)";
            ...
            else if (this.rbtnGHZC.Checked)
            {
                ...
                and not exists (select 1 from YBhisDZdr20171231 c where c.hisxmbh = (a.bzcodn + a.bzkeyx))";
            ...
            else if (this.rbtnYLK.Checked)
            {
                ...
                where a.pakind = 'MZ' 
                and a.pasequ = '0004' 
                and not exists (select 1 from YBhisDZdr20171231 c where c.hisxmbh = (a.pakind + a.pasequ))";
            ...
            DataTable dt = CliUtils.ExecuteSql("sybdj_ls", "cmd", sql, CliUtils.fLoginDB, true, CliUtils.fCurrentProject).Tables[0];
        ...
        void BindDZGrids()
        {
            ...
            string sql = string.Format("select Hisxmbh, Hisxmmc, ybxmbh, ybxmmc, sfxmzldm from YBhisDZdr20171231 a where a.sfxmzldm in ({0}) and scbz = {1}", sfzl, scbz);
        ...
        private void btnQXDZ_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvHisYBDZ.CurrentRow != null && this.dgvHisYBDZ.CurrentRow.Index != -1 && dgvHisYBDZ.SelectedRows.Count > 0 && dgvHisYBDZ.SelectedRows[0].Cells[0].Value != null)
                {
                    ...
                    obj = CliUtils.CallMethod("sybdj_ls", "DeleteHisYBDZProject", obj);
        ...
        private void btnDZ_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obj = CliUtils.CallMethod("sybdj_ls", "InsertHisYBDZProject", obj);
        ...
        private void rbtnGHZC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                from bztbd a where a.bzcodn in ('A6', 'A7') and not exists (select 1 from YBhisDZdr20171231 c where c.hisxmbh = (a.bzcodn + a.bzkeyx))";
        ...
        private void btnscdz_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (obj[1].ToString() == "1")
                {
                    ...
                    string sql = string.Format("update ybhisdzdr20171231 set scbz = 1 where hisxmbh in ({0})", xmbhs);
                    obj = new object[] { sql };
                    obj = CliUtils.CallMethod("sybdj_ls", "BatExecuteSql", obj);
        ...
        {
            BindDZGrids();
            MessageBox.Show(dgvHisYBDZ.Rows.Count.ToString());
        }

        private void rbtnAlreadyUpload_Click(object sender, EventArgs e)
        {
            BindDZGrids(); MessageBox.Show(dgvHisYBDZ.Rows.Count.ToString());
        }
        ...
        private void txtYBProjectName_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                string sql = @"select a.dm, a.dmmc, len(a.dmmc) lendmmc, a.sfxmdj, a.sfxmdjdm type, a.gg, a.sccj, a.jx from ybMRdr20171231 a where 1 = 1";
