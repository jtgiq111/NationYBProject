...
{
    public partial class Frm_ybbbrydrYT : InfoForm
    {
        public Frm_ybbbrydrYT()
        {
            InitializeComponent();
        }
        ...
        private void Fybbbry_Load(object sender, EventArgs e)
        {
            ...
            txt_lyjg.setWhere = "b6lynm like '%医疗保险%' and b6comp = '" + CliUtils.fSiteCode + "' and (isnull(b6pymx, '') like '%{0}%' or b6lynm like '%{0}%')";
        ...
        private bool GetYBInfo(ref string backmsg)
        {
            ...
            //if (ck_lsybk.Checked)
            //    ybklx = "1";
            //if (ck_ydrybz.Checked)
            //    qdjbbz = "2";
            object[] objParam = { ybklx, qdjbbz };

            object[] back_mess = yb_interface.ybs_interface("2201", objParam);
        ...
        private void btn_RegisterYB_Click(object sender, EventArgs e)
        {
            ...
            object[] back_mess, param = new object[] { txt_zyno.Text, txt_yllb.Tag, txt_bz.Tag, txt_bz.Text, txt_grbh.Tag, txt_lyjg.Tag, txt_lyjg.Text, txt_yllb.Text, txt_dgys.Tag, txt_dgys.Text, "", "" };
