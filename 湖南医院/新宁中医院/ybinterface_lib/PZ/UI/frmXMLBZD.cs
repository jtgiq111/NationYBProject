...
{
    public partial class frmXMLBZD : InfoForm
    {
        ...
        private void txtXMJS_Click(object sender, EventArgs e)
        {
            txtXMJS.Text = string.Empty;
            txtXMJS.ForeColor = Color.Black;
        }

        private void txtXMJS_TextChanged(object sender, EventArgs e)
        {
            ...
            DataSet dsXM = CliUtils.ExecuteSql("sybdj", "cmd", strSql, CliUtils.fLoginDB, true, CliUtils.fCurrentProject);
            
            dgvXMLBZD.AutoGenerateColumns = false;
            dgvXMLBZD.DataSource = dsXM.Tables[0].DefaultView;
        }

        private void frmXMLBZD_Load(object sender, EventArgs e)
        {
            #region 数据绑定
            //项目类别
            ...
            DataSet dsXMLB=CliUtils.ExecuteSql("sybdj", "cmd", strSql, CliUtils.fLoginDB, true, CliUtils.fCurrentProject);
            ...
            DataSet dsCSZD = CliUtils.ExecuteSql("sybdj", "cmd", strSql, CliUtils.fLoginDB, true, CliUtils.fCurrentProject);
            ...
            DataSet dsDQZD = CliUtils.ExecuteSql("sybdj", "cmd", strSql, CliUtils.fLoginDB, true, CliUtils.fCurrentProject);
        ...
        {
            txtXMJS_TextChanged(sender,e);
        }

        private void dgvXMLBZD_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
