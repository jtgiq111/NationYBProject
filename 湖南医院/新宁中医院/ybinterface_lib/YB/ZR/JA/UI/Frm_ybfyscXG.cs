...
{
    public partial class Frm_ybfyscXG : InfoForm
    {
        public Frm_ybfyscXG()
        {
            InitializeComponent();
        ...
        {
            string sql = string.Format(@"select yysfxmbm,yysfxmmc,a.sfxmzxmc,sfxmzxbm,dj,sl,je,b.sflb,sfxmdj from ybcfmxscindr  a
            ...
            if (ds.Tables[0].Rows.Count == 0)
            {
                sql = string.Format(@"select '' sfxmzxbm,'' sfxmzxmc,a.z3djxx as dj,case LEFT(a.z3endv,1) when '4' then -a.z3jzcs else a.z3jzcs end as sl,
                                    ...
                                    case LEFT(a.z3endv,1) when '4' then -a.z3jzje else a.z3jzje end as je,a.z3item as yysfxmbm, a.z3name as yysfxmmc,
                                    b.sflb,b.sfxmdj
                                    from zy03dz a left join ybhisdzdr b on 
