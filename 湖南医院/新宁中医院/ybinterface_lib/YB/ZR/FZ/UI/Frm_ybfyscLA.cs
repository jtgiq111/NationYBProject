...
{
    public partial class Frm_ybfyscLA : InfoForm
    {
        public Frm_ybfyscLA()
        {
            InitializeComponent();
        ...
        {
            string sql = string.Format(@"select yyxmdm as yysfxmbm,yyxmmc as yysfxmmc,a.yybxmbh as sfxmzxbm,a.ybxmmc as ybxmmc,dj,sl,je,a.sflb,a.sfxmdj from ybcfmxscfhdr  a
        ...
        private void btnFYSC_Click(object sender, EventArgs e)
        {
            if (infoDataGridView1.SelectedRows.Count !=0 )
            {
                ...
                {
                    object[] back_mess, param = new object[] { zyno, txtYLFY.Text.Trim() };
