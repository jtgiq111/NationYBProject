...
{
    public partial class Frm_ybbbrydrNK : InfoForm
    {
        public Frm_ybbbrydrNK()
        {
            InitializeComponent();
            alv_YLLB.WhereStr = "bzcodn = 'YL' and isnull(bzusex,'')!=''  and bzmem3 like '%Z%'";
        }
        ...
        private void txt_zyno_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    txt_lyjg.Text = dr["z1lynm"].ToString();
                    txt_lyjg.Tag = dr["z1lyjg"].ToString();
                    txt_dgys.Tag = dr["z1empn"].ToString();
                    txt_dgys.Text = dr["z1mzys"].ToString();
                    dtp_ryrq.Value = Convert.ToDateTime(dr["z1date"]);
                    txt_ks.Text = dr["z1ksnm"].ToString();
                }
        ...
        private void Fybbbry_Load(object sender, EventArgs e)
        {
            ...
            //txt_yllb.setWhere = "bzcodn = 'YL' and isnull(bzusex,'')!='' " + strBZ+" and bzmem3 like '%Z%' and (bzpymx like '%{0}%' or bzwbmx like '%{0}%' or bzname like '%{0}%' or bzmem1 like '%{0}%')";
            ...
            txt_lyjg.setWhere = "b6lyjg like '%医保%' and b6chk1=1 and b6comp = '" + CliUtils.fSiteCode + "' and (isnull(b6pymx, '') like '%{0}%' or b6lynm like '%{0}%')";
            ...
            txt_dgys.setWhere = "b1name like '%{0}%' or b1empn like '%{0}%'  or b1pymx like '%{0}%' or b1wbmx like '%{0}%'";
        ...
        private void txt_GotFocus(object sender, EventArgs e)
        {
            ...
            switch (utb.Name)
            {
                ...
                //            if (txt_yllb.Tag.ToString() == "21")
                //            {
                //                idsybbz.SetWhere("bz=0");
                //                idsybbz.WhereStr = "bz=0";
                //                strBZ = " and bz=0";
                //            }
                //            else
                //            {
                //                idsybbz.SetWhere("bz=1");
                //                idsybbz.WhereStr = "bz=1";
                //                strBZ = " and bz=1";
                //            }
                ...
                //            if (!string.IsNullOrEmpty(txt_yllb.Text))
                //            {
                //                if (txt_yllb.Tag.ToString() == "21")
                //                {
                //                    idsybbz.SetWhere("bz=0");
        ...
        {
            object[] back_mess = Functions.ybs_interface("2201", null);
            ...
            if (back_mess[1].ToString() == "1")
            {
                ...
                string Jflx = strP[29].ToString(); //缴费类型
        ...
        private void btn_RegisterYB_Click(object sender, EventArgs e)
        {
            ...
            object[] back_mess, param = new object[] { txt_zyno.Text, txt_yllb.Tag, txt_bz.Tag, txt_bz.Text, txt_grbh.Tag, txt_lyjg.Tag, txt_lyjg.Text, txt_yllb.Text, txt_dgys.Tag, txt_dgys.Text, dtp_ryrq.Text };
            btn_RegisterYB.Enabled = false;
            back_mess = Functions.ybs_interface("4100", param);
        ...
        private void txt_yllb_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txt_yllb.Text)) 
            {
                txt_yllb.Tag = "";
        ...
        {
            //if (string.IsNullOrEmpty(txt_bz.Text)) 
            //{
        ...
        private void alv_YLLB_AfterConfirm(object sender, EventArgs e)
        {
            if (txt_yllb.Tag.ToString() == "21")
            {
                alv_bz.FilterString = string.Format(@" bz=0");
            }
            else 
            {
                alv_bz.FilterString = string.Format(@" bz=1");
            }
        }
