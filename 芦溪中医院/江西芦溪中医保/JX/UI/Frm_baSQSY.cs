...
namespace yb_interfaces
{
    public partial class Frm_baSQSY : InfoForm
    {
        ...
        {
            foreach (Control ctl in this.dbzs.Controls)
            {
                if (ctl is TextBox)
                    ctl.Text = "";
            }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            string dbzksrq = "";
            string dbzjsrq = "";
            if (this.cmbdbzsjlx.SelectedItem==null)
            {
                MessageBox.Show("请选择事件类型！");
                return;
            }

            if (this.cmbdbzsbyl.SelectedItem == null)
            {
                MessageBox.Show("请选择申报来源！");
                return;
            }
            ...
            object[] back_mess = yb_interface_jx.YBZDJBBADJ(param);
            if (back_mess[1].ToString() == "1")
            {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            object[] param = new object[] { mxlsh, rybh,"" };
            object[] back_mess = yb_interface_jx.YBTDJBBACX(param);
            if (back_mess[1].ToString() == "1")
            {
