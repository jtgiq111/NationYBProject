...
{
    public partial class Frm_mzybjsfycxLX : InfoForm
    {
        public Frm_mzybjsfycxLX()
        {
            InitializeComponent();
        }
        ...
        private void Frm_mzybjsfycxXG_Load(object sender, EventArgs e)
        {
            ...
            alvWHERE_MZ.SetColumnParam.AddQueryColumn("djhin");
            ...
            alvWHERE_MZ.SetColumnParam.AddViewColumn("ylfze", "金额", 100);
            alvWHERE_MZ.SetColumnParam.AddViewColumn("djhin", "结算单号", 100);
            ...
            string strSql = string.Format(@"select distinct ylfze,a.jzlsh,a.xm, a.grbh, a.yldylb,a.ksmc,a.cwh,a.ysxm,
                                                ...
                                                c.djhin,c.sysdate from ybmzzydjdr a
        ...
        private void btnDJCX_MZ_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("无门诊流水号", "提示");
                txtJZLSH_MZ.Focus();
                return;
            }
            object[] obj = { txtJZLSH_MZ.Text.Trim(),"" };
            obj = Function.ybs_interface("3101", obj);
        ...
        private void alvWHERE_MZ_AfterConfirm(object sender, EventArgs e)
        {
            ...
            if (alvWHERE_MZ.currentDataRow != null)
            {
                ...
                txtJSH_MZ.Text = alvWHERE_MZ.currentDataRow["djhin"].ToString();
                ...
                txt_jsje.Text = alvWHERE_MZ.currentDataRow["ylfze"].ToString();
            }
        }
        ...
        private void btnJSCX_MZ_Click(object sender, EventArgs e)
        {
            ...
            obj = Function.ybs_interface("3302", obj);
            MessageBox.Show(obj[2].ToString());
        }
        ...
        private void btnJSD_MZ_Click(object sender, EventArgs e)
        {
            ...
            object[] obj = { txtJZLSH_MZ.Text.Trim(), txtJSH_MZ.Text.Trim() };
            obj = yb_interface_jx.YBMZJSD(obj);
            MessageBox.Show(obj[2].ToString());
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            object[] obj = { txtJZLSH_MZ.Text.Trim(), txtJSH_MZ.Text.Trim() };
            obj = yb_interface_jx.YBMZJSQD(obj);
            MessageBox.Show(obj[2].ToString());
        }
    }
}
